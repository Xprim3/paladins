<template>
  <header
    class="fixed top-0 left-0 right-0 z-50 bg-dark-bg border-b border-dark-border shadow-lg opacity-100"
  >
    <nav class="container mx-auto px-4">
      <div
        class="flex items-center justify-between h-14 sm:h-16 md:h-20 min-w-0 gap-2"
      >
        <!-- Logo/Brand -->
        ...
        <!-- Desktop Navigation -->
        <div
          class="hidden xl:flex items-center flex-wrap gap-x-3 gap-y-2 xl:gap-x-4 2xl:gap-x-6 flex-1 justify-end min-w-0"
        >
          <a
